...
const TestimonialSection: React.FC = () => {
  ...
  return (
    <div className="relative pt-12 pb-40 overflow-hidden">
      <div className="container mx-auto px-6 flex flex-col gap-16">
        ...
        <div className="relative md:hidden">
          ...
          >
            {/* <!-- Testimonial Cards --> */}
            <div className="flex-none bg-[#363636] text-white rounded-lg shadow-lg p-6 w-[320px]">
            ...
            <div className="relative flex-none bg-[#363636] text-white rounded-lg shadow-lg p-6 w-[320px]">
              <p className="italic mb-4">
          ...
          {/* Arrows */}
          <button
            className="absolute -bottom-20 left-0 transform -translate-y-1/2 bg-orange-500 text-white p-2 rounded-full"
            onClick={() =>
          ...
          <button
            className="absolute -bottom-20 right-0 transform -translate-y-1/2 bg-orange-500 text-white p-2 rounded-full"
            onClick={() =>
              setCurrentIndex(
