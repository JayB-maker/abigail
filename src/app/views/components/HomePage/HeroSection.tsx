  ...
  return (
    <div className="flex flex-col items-center justify-between lg:flex-row gap-6 pt-32 pb-10 md:py-36 lg:pt-44 lg:pb-20">
      <div className="flex flex-col gap-4">
        ...
        <p className="hidden md:block text-center md:text-left file:text-2xl ">
          I transform your idea into market <br /> ready solution
        </p>
        <p className="md:hidden text-center md:text-left file:text-2xl ">
          I transform your idea into market ready solution
        </p>
      </div>
